...
INCLUDE_DIR="-I./ -Idriver -Irenderer -Iintegrator -Isampler -Iutils -I../thirdparty/ctpl -I../thirdparty/optparse -I/milk/code/central/include/SDL/2.0/SDL2/ -I/milk/code/central/include/OpenEXR/2.0.1/"
