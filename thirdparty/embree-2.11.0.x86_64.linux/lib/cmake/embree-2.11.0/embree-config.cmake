...
SET(EMBREE_LIBRARY ${CMAKE_CURRENT_LIST_DIR}/../../libembree.so.2)

SET(EMBREE_TASKING_TBB      ON)
SET(EMBREE_USE_PACKAGED_TBB ON)

IF (${EMBREE_TASKING_TBB} AND ${EMBREE_USE_PACKAGED_TBB})
  SET(EMBREE_TBB_LIBRARY ${CMAKE_CURRENT_LIST_DIR}/../../libtbb.so.2)
  SET(EMBREE_TBB_LIBRARY_MALLOC ${CMAKE_CURRENT_LIST_DIR}/../../libtbbmalloc.so.2)
ELSE()
